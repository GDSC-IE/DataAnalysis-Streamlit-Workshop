...
with st.sidebar:
    ...
    if st.session_state.process_pdf and st.session_state.pdf_docs_cached and "flashcards_list" not in st.session_state:
        print("#####context_doc here######")
        st.session_state.context, st.session_state.flashcards_list = context_doc(
            st.session_state.pdf_docs_cached, chunk_size, st.session_state.flashcard_number)
